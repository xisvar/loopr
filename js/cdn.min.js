( () => {
    ...
    : Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector
      ...
      , ue = function(e, t) {
        if (getComputedStyle(e).visibility === "hidden")
            return !0;
        var a = C.call(e, "details>summary:first-of-type")
          , u = a ? e.parentElement : e;
        if (C.call(u, "details:not([open]) *"))
            return !0;
        if (!t || t === "full")
            for (; e; ) {
      ...
      , oe = function(e) {
        if (L(e) || e.tagName === "SELECT" || e.tagName === "TEXTAREA" || e.tagName === "BUTTON")
      ...
      , W = function(e, t) {
        ...
        var a = []
          , u = []
          , r = M(e, t.includeContainer, se.bind(null, t));
      ...
      , V = function(e, t) {
        var a = document, u = fe({
            ...
            if (!o)
                return null;
            var c = o;
            if (typeof o == "string" && (c = a.querySelector(o),
            !c))
                throw new Error("`".concat(n, "` refers to no known node"));
            if (typeof o == "function" && (c = o(),
            !c))
            ...
            if (l({}, "initialFocus") === !1)
                return !1;
            if (b("initialFocus") !== null)
                n = b("initialFocus");
            else if (p(a.activeElement))
                n = a.activeElement;
            else {
            ...
            if (!p(n.target)) {
                if (A(u.clickOutsideDeactivates, n)) {
                    s.deactivate({
                        returnFocus: u.returnFocusOnDeactivate && !O(n.target)
                    });
                    return
                }
            ...
            var o = p(n.target);
            o || n.target instanceof Document ? o && (r.mostRecentlyFocusedNode = n.target) : (n.stopImmediatePropagation(),
            m(r.mostRecentlyFocusedNode || v()))
        }, k = function(n) {
            h();
            var o = null;
            if (r.tabbableGroups.length > 0) {
                ...
                if (c < 0)
                    n.shiftKey ? o = r.tabbableGroups[r.tabbableGroups.length - 1].lastTabbableNode : o = r.tabbableGroups[0].firstTabbableNode;
                else if (n.shiftKey) {
                    var d = x(r.tabbableGroups, function(N) {
                        var D = N.firstTabbableNode;
                        return n.target === D
                    });
                    if (d < 0 && r.tabbableGroups[c].container === n.target && (d = c),
                    d >= 0) {
                        var y = d === 0 ? r.tabbableGroups.length - 1 : d - 1
                          , F = r.tabbableGroups[y];
                    ...
                    if (T < 0 && r.tabbableGroups[c].container === n.target && (T = c),
                    T >= 0) {
            ...
            A(u.clickOutsideDeactivates, n) || p(n.target) || A(u.allowOutsideClick, n) || (n.preventDefault(),
            n.stopImmediatePropagation())
        }, P = function() {
            if (!!r.active)
                return U.activateTrap(s),
                r.delayInitialFocusTimer = u.delayInitialFocus ? K(function() {
                    m(v())
                }) : m(v()),
            ...
            if (!!r.active)
                return a.removeEventListener("focusin", w, !0),
        ...
        return s = {
            activate: function(n) {
                ...
                return d ? (d(r.containers.concat()).then(y, y),
                this) : (y(),
                this)
            },
            deactivate: function(n) {
                ...
                o && o();
                var y = l(n, "returnFocus", "returnFocusOnDeactivate")
                  , F = function() {
                    K(function() {
                        y && m(S(r.nodeFocusedBeforeActivation)),
                        c && c()
                    })
                };
                return y && d ? (d(S(r.nodeFocusedBeforeActivation)).then(F, F),
                this) : (F(),
                this)
            },
            pause: function() {
                return r.paused || !r.active ? this : (r.paused = !0,
                j(),
                this)
            },
            unpause: function() {
                return !r.paused || !r.active ? this : (r.paused = !1,
                h(),
                P(),
                this)
            },
    ...
    function z(i) {
        ...
        i.directive("trap", i.skipDuringClone( (a, {expression: u, modifiers: r}, {effect: s, evaluateLater: l, cleanup: p}) => {
            let b = l(u)
              , v = !1
              , h = {
                escapeDeactivates: !1,
            ...
            s( () => b(E => {
                v !== E && (E && !v && setTimeout( () => {
                    r.includes("inert") && (g = Y(a)),
                    r.includes("noscroll") && (w = pe()),
                    S.activate()
                }
                ),
                !E && v && k(),
